...
t.CostBreakdown
from t
WHERE t.AccountId = '1EEF1B1A-A415-43F3-88C5-2D5EBC503529' 
AND t.DP_SERVICELINE_KEY = 'A0A885C1-8A23-4218-A7A0-F7236ADBF4AD'       
AND  t.UpsOrderNumber = '86326467'       
AND t.is_inbound=0 and t.is_deleted=0
